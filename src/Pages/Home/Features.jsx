...
const Features = () => {
  ...
  const cardBg = theme === "light" ? "bg-primary-100" : "bg-gray-800";
  ...
  return (
    <section className={`${sectionBg}`}>
      <div className="py-8 px-4 mx-auto sm:py-16 sm:px-20">
        <div className="mb-8 lg:mb-16">
          <h2
            className={`mb-4 text-4xl tracking-tight font-extrabold ${titleColor}`}
          >
            Discover the Power of Our Platform
          </h2>
        ...
        <div className="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-12 md:space-y-0">
          <div>
            <div
              className={`flex justify-center items-center mb-4 w-10 h-10 rounded-full ${cardBg} lg:h-12 lg:w-12`}
            >
          ...
          <div>
            <div
              className={`flex justify-center items-center mb-4 w-10 h-10 rounded-full ${cardBg} lg:h-12 lg:w-12`}
            >
              <img src={user_friendly} alt="User Friendly" />
            </div>
            <h3 className={`mb-2 text-xl font-bold ${titleColor}`}>
          ...
          <div>
            <div
              className={`flex justify-center items-center mb-4 w-10 h-10 rounded-full ${cardBg} lg:h-12 lg:w-12`}
            >
              <img src={track_progress} alt="Track Progress" />
            </div>
            <h3 className={`mb-2 text-xl font-bold ${titleColor}`}>
              Track Your Progress
            </h3>
